...
- 例) サブネットをインターネットと通信できるようにするには全ての通信(0.0.0.0/0)をインターネットゲートウェイ(igw-)に向けるようにルートテーブルを設定する。
    - <img width="611" alt="Screenshot 2023-01-28 at 11 18 05" src="https://user-images.githubusercontent.com/61643054/215237355-49b09a50-c017-4ac4-a2c5-dcac029573fa.png">
